...
export default function A2Screen({ navigation }: { navigation: any }) {
  ...
  const isAllMastered = TOTAL_A2_WORD_COUNT > 0 && masteredLen >= TOTAL_A2_WORD_COUNT;

  async function handleReset() {
    await resetProgress('A2');
    const pr = await loadLevelProgress('A2');
    setProgress(pr);
  }
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <Text style={styles.headerTitle}>A2 Temel</Text>
          <Text style={styles.headerSub}>{TOTAL_A2_WORD_COUNT} kelime · Grundwörter</Text>
        </View>
        <View style={styles.a2Badge}>
          <Text style={styles.a2BadgeText}>A2</Text>
        </View>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity
          ...
          <View style={styles.cardFooterRow}>
            <Text style={styles.cardMeta}>{TOTAL_A2_WORD_COUNT} kelime · {
        ...
        {progress !== null && (
          <View style={styles.masteryCard}>
            ...
            {isAllMastered ? (
              <>
                <Text style={styles.masterySubText}>🏆 Tüm A2 kelimelerini öğrendin!</Text>
...
const styles = StyleSheet.create({
  ...
  a2BadgeText: { fontSize: 15, fontWeight: '800', color: '#fff', letterSpacing: 0.5 },
  ...
  activePill: {
    ...
    borderWidth: 1, borderColor: 'rgba(59,125,216,0.3)',
  },
  ...
  cardBoşluk: {
    ...
    borderWidth: 1, borderColor: 'rgba(59,125,216,0.28)',
    borderLeftWidth: 4, borderLeftColor: C.primary,
    shadowColor: C.primary, shadowOffset: { width: 0, height: 2 },
