...
const styles = StyleSheet.create({
  ...
  matchedArea: { gap: 3, marginBottom: 8, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: C.border, alignSelf: 'stretch' },
  matchedChip: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderRadius: 6, paddingHorizontal: 8, height: 26, gap: 6, overflow: 'hidden' },
  matchedDot: { width: 6, height: 6, borderRadius: 3, flexShrink: 0 },
  matchedChipText: { flex: 1, fontSize: 11, fontWeight: '600' },
  matchedArrow: { fontSize: 9, color: C.textFaint, flexShrink: 0 },
  pairsBtn: {
    borderWidth: 1.5, borderColor: C.borderBright, borderRadius: 14,
